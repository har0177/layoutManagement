...
<head>
	...
	<title>Privacy Policy for Empower Energy</title>
</head>
<body>
<h1>Privacy Policy for Empower Energy</h1>
<div class="page-content">

	<p>At Spark Empower, accessible from https://sparkemp.io/, one of our main priorities is the privacy of our visitors.
		This Privacy Policy document contains types of information that is collected and recorded by Spark Empower and how
		we use it.</p>
	...
	<p>This Privacy Policy applies only to our online activities and is valid for visitors to our website with regards to
		the information that they shared and/or collect in Spark Empower. This policy is not applicable to any information
	...
	<p>Spark Empower follows a standard procedure of using log files. These files log visitors when they visit websites.
	...
	<P>You may consult this list to find the Privacy Policy for each of the advertising partners of Spark Empower.</p>

	<p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that are used in
		their respective advertisements and links that appear on Spark Empower, which are sent directly to users' browser.
	...
	<p>Note that Spark Empower has no access to or control over these cookies that are used by third-party
		advertisers.</p>

	<h2>Third Party Privacy Policies</h2>

	<p>Spark Empower's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to
	...
	<p>Spark Empower does not knowingly collect any Personal Identifiable Information from children under the age of 13.
	...
	<h2>Information collected outside of the website:</h2>
	<p>
		We use the information collected outside of the website to provide and improve the service. The information of our
		consumers collected through our website will not be sold or distributed to any third party. The consumers will have
		access to their information and have the right to delete it according to CCPA.</p>
</div>
</body>
</html>
