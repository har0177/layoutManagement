...
(function (a) {
  ...
  function i (a, b) {a && (a.unselectable = b ? 'off' : 'on', a.onselectstart = function () {return b}, a.style && (a.style.MozUserSelect = b ? '' : 'none'))}
...
(function (d) {
  ...
  d.event.special.mousewheel = {
    setup: function () {if (this.addEventListener) for (var a = c.length; a;) this.addEventListener(c[--a], e, !1) else this.onmousewheel = e},
    teardown: function () {if (this.removeEventListener) for (var a = c.length; a;) this.removeEventListener(c[--a], e, !1) else this.onmousewheel = null}
  }
  d.fn.extend({
