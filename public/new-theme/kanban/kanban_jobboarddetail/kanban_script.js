...
function initializeBoards () {
  dataColors.forEach(item => {
    let htmlString = `
		<div class="board" style="margin-top: 10px; background: #25AAE1; border-radius: 10px; box-shadow: 0 2px 14px 0 rgb(0 0 0 / 16%">
			<div class="card thead_item">
					<h3 style="background-color: #25AAE1; color: white; font-size: 19px; " class="text-center">${item.title.toUpperCase()}</h3>
			</div>
...
function appendComponents (card) {
  ...
  let htmlString = `
		<div name="cardDiv" id=${card.id.toString()} class="kanbanCard ${card.position}" draggable="true">
