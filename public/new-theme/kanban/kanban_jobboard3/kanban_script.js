...
function initializeBoards () {
  dataColors.forEach(item => {
    let htmlString = `
		<div class="board" style="margin-top: 10px; background: #F1FFFF; border-radius: 10px; box-shadow: 0 2px 14px 0 rgb(0 0 0 / 16%">
			<div class="card thead_item">
					<h3 style="background-color: #F1FFFF; color: black; font-size: 19px; " class="text-center">${item.title.toUpperCase()}</h3>
			</div>
