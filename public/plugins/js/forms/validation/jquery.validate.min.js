  ...
  a.extend(a.fn, {
    ...
    prototype: {
      ...
      check: function (b) {
        ...
        var c, d, e, f, g = a(b).rules(), h = a.map(g, function (a, b) {return b}).length, i = !1,
        ...
        for (d in g) {
          ...
          } catch (k) {throw this.settings.debug && window.console && console.log('Exception occurred when checking element ' + b.id + ', check the \'' + e.method + '\' method.', k), k instanceof TypeError && (k.message += '.  Exception occurred when checking element ' + b.id + ', check the \'' + e.method + '\' method.'), k}
        }
      ...
      dependTypes: {
        ...
        string: function (b, c) {return !!a(b, c.form).length},
    ...
    methods: {
      ...
      date: function () {
        var a = !1
        return function (b, c) {return a || (a = !0, this.settings.debug && window.console && console.warn('The `date` method is deprecated and will be removed in version \'2.0.0\'.\nPlease don\'t use it, since it relies on the Date constructor, which\nbehaves very differently across browsers and locales. Use `dateISO`\ninstead or one of the locale specific methods in `localizations/`\nand `additional-methods.js`.')), this.optional(c) || !/Invalid|NaN/.test(new Date(b).toString())}
      }(),
      ...
      step: function (b, c, d) {
        var e, f = a(c).attr('type'), g = 'Step attribute on input type ' + f + ' is not supported.',
          ...
          }, l = function (a) {return Math.round(a * Math.pow(10, e))}, m = !0
        if (j) throw new Error(g)
        return e = k(d), (k(b) > e || l(b) % l(d) !== 0) && (m = !1), this.optional(c) || m
      },
      equalTo: function (b, c, d) {
        var e = a(d)
        return this.settings.onfocusout && e.not('.validate-equalTo-blur').length && e.addClass('validate-equalTo-blur').on('blur.validate-equalTo', function () {a(c).valid()}), b === e.val()
      },
